...
@dataclass
class AMaPOConfig(TrainingArguments):
    r"""
    AMaPOConfig collects all training arguments related to the [`AMaPOTrainer`] class.
    ...
    Parameters:
        ...
        beta (`float`, defaults to 2.0):
            The beta factor in AMaPO loss.
        sft_weight (`float`, defaults to 0.0):
            SFT loss weight added to the AMaPO loss (0.0 is not using SFT).
